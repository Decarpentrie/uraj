						...
						<div class="property-item-content <?php echo join( ' ', $property_item_content_class ); ?>">
							...
							<?php if ( $layout_style != 'property-zigzac') :?>
								<div class="property-element-inline">
									...
									<?php endif; ?>
									<div class="property-date"><i class="fa fa-calendar accent-color"></i><?php printf( _x(' %s ago', '%s = human-readable time difference', 'essential-real-estate' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></div>
								</div>
							<?php endif; ?>
		...
		<?php endif; ?>
			...
			if ( $show_paging ) {?>
				<div class="property-paging-wrap"
					 ...
					 data-property-labels="<?php echo esc_attr( $property_labels ); ?>"
