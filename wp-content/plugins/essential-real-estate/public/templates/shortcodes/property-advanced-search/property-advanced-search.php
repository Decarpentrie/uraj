...
$bathrooms_enable = $price_enable = $price_is_slider = $area_enable = $area_is_slider = $land_area_enable = $land_area_is_slider = $country_enable = $state_enable = $neighborhood_enable = $labels_enable = $garage_enable =
...
$property_status = get_categories(array('taxonomy' => 'property-status', 'hide_empty' => 1));
...
$status_default = '';
if (is_array($property_status_arr)) {
...
if ($column == '1') {
    $class_col_input = 'col-md-12 col-sm-12 col-xs-12 col-mb-12';
} elseif ($column == '2') {
    $class_col_input = 'col-md-6 col-sm-6 col-xs-12 col-mb-12';
} elseif ($column == '3') {
    $class_col_input = 'col-md-4 col-sm-6 col-xs-6 col-mb-12';
} elseif ($column == '4') {
    $class_col_input = 'col-md-3 col-sm-6 col-xs-6 col-mb-12';
}
?>
        ...
        <div class="form-search-inner">
            <div class="ere-search-content">
                ...
                <div data-href="<?php echo esc_url($advanced_search) ?>" class="search-properties-form">
                    ...
                    <div class="row">
                        <?php
                        $search_fields = ere_get_option('search_fields', array('property_status',  'property_type', 'property_title', 'property_address','property_country', 'property_state', 'property_city', 'property_neighborhood', 'property_bedrooms', 'property_bathrooms', 'property_price', 'property_size', 'property_land', 'property_labels', 'property_garage', 'property_identity', 'property_feature'));
                                ...
                                case 'property_status':
                                    if ($status_enable == 'true' && $layout != 'tab') {
                                        ere_get_template('property/search-fields/' . $field . '.php', array(
                                            'css_class_field' => $class_col_input,
                        ...
                        ?>
                        <div class="<?php echo esc_attr($class_col_input); ?> form-group submit-search-form pull-right">
