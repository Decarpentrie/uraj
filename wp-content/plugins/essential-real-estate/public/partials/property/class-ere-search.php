            ...
            else
            {
                ...
                if (is_array($property_price_array_min) && !empty($property_price_array_min)) {
                    foreach ($property_price_array_min as $n) {
                        ...
                        $min_price_html.=ere_get_format_number($n).'<span class="price-currency-sign">'.ere_get_option('currency_sign').'</span></option>';
                    }
                }
                ...
                if (is_array($property_price_array_max) && !empty($property_price_array_max)) {
                    foreach ($property_price_array_max as $n) {
                        ...
                        $max_price_html.=ere_get_format_number($n).'<span class="price-currency-sign">'.ere_get_option('currency_sign').'</span></option>';
                    }
                }
            }
