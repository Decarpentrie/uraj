    ...
    class ERE_Template_Hooks
    {
        ...
        public function archive_property_search()
        {
            ...
            if($enable_archive_search_form=='1'):
                $hide_archive_search_fields = ere_get_option('hide_archive_search_fields', array('property_country','property_state','property_neighborhood','property_labels'));
                ...
                $labels_enable = !in_array("property_labels", $hide_archive_search_fields);
        ...
        public function advanced_property_search()
        {
            ...
            if($enable_advanced_search_form=='1'){
                ...
                echo do_shortcode('[ere_property_advanced_search layout="tab" column="3" color_scheme="color-dark" status_enable="true" type_enable="true" title_enable="true" address_enable="true" country_enable="true" state_enable="true"  city_enable="true"  neighborhood_enable="true" bedrooms_enable="true" bathrooms_enable="true" price_enable="true" price_is_slider="'.($property_price_field_layout==1).'" area_enable="true" area_is_slider="'.($property_size_field_layout==1).'" land_area_enable="true" land_area_is_slider="'.($property_land_field_layout==1).'" labels_enable="true" garage_enable="true" property_identity_enable="true" other_features_enable="true"]');
            }
        }
        /**
         * property_sidebar
