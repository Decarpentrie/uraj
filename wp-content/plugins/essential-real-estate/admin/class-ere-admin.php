                            ...
                            'fields' => array(
                                array(
                                    ...
                                    'options' => array(
                                        ...
                                        'property_city' => esc_html__('City', 'essential-real-estate'),
                                    ...
                                    'default' => array(
                                        'property_status',  'property_type', 'property_title', 'property_address','property_country', 'property_state', 'property_city', 'property_neighborhood', 'property_bedrooms', 'property_bathrooms', 'property_price', 'property_size', 'property_land', 'property_labels', 'property_garage', 'property_identity', 'property_feature'
                                    )
                                ),
                            )
                        ),
                                                ...
                                                array(
                                                    ...
                                                    'fields' => array(
                                                        array(
                                                            ...
                                                            'type' => 'select',
                                                            'data' => 'taxonomy',
                                                            'data_args' => array('taxonomy' => 'property-status', 'hide_empty' => 1, 'orderby' => 'ASC'),
                                                        ),
                                                        array(
                        ...
                        array(
                            ...
                            'fields' => array(
                                array(
                                    ...
                                    'id' => 'agent_agencies',
                                    'data' => 'taxonomy',
                                    'data_args' => array('taxonomy' => 'agencies', 'args' => array('hide_empty' => 0)),
                                    'multiple' => true,
